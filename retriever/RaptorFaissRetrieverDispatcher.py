...
class RaptorFaissRetrieverDispatcher(RetrieverDispatcher):
    chat_model: BaseChatModel
    embedding_model: Embeddings

    def __init__(self, embedding_model: Embeddings, chat_model: BaseChatModel):
    ...
    def embed_cluster_summarize_texts(
        ...
        # Summarization
        template = """제공된 문서의 자세한 요약을 제공하십시오.
    ...
    def get_optimal_clusters(
            self, embeddings: np.ndarray, max_clusters: int = 50, random_state: int = 42
    ) -> int:
        """
